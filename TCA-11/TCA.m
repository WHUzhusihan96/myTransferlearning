...
% Inputs: 
%%% X_src          :    source feature matrix, ns * n_feature#源域特征矩阵
%%% X_tar          :    target feature matrix, nt * n_feature#目标域特征矩阵
%%% options        :    option struct#选择的结构，分别为
%%%%% lambda       :    regularization parameter正则化参数
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	M = e * e';%两个域情况下的L矩阵
	M = M / norm(M,'fro');%做标准化，对应论文中对应L矩阵
	H = eye(n)-1/(n)*ones(n,n);%论文中对应H矩阵
